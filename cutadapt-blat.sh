...
wget http://ftp.flybase.net/genomes/Drosophila_melanogaster/dmel_r6.32_FB2020_01/fasta/dmel-all-gene-r6.32.fasta.gz
gunzip -d dmel-all-gene-r6.32.fasta.gz
...
do
    ...
    blat -t=DNA -q=RNA dmel-all-gene-r6.32.fasta  $NAME\.trimtail.fasta  $NAME\.trimtail.psl
